![Npm version](https://img.shields.io/npm/v/@aenode/material)
![Npm downloads](https://img.shields.io/npm/dm/@aenode/material)
...
![Bundle size](https://img.shields.io/bundlephobia/min/@aenode/material)
...
```bash
pnpm add @aenode/material
```

## 💖 Support My Work

If you find my open-source contributions or the **@aenode/material** project helpful, consider supporting my work. Your sponsorship helps me maintain these projects and explore new enterprise patterns.
...
<p align="left">
<a href="mailto:aenode+aenode-material@proton.me">
